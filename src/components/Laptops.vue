<template>
  <div>
    ...
    <div class="row mx-2 my-2">
      <div class="col-md-3 outerview" v-for="laptopData in productsList" :key="laptopData.id">
        <div class="cardTemplate outer1">
          <div class="card mb-4 outer2">
            <img class="card-img-top mt-2" v-bind:src="laptopData.productImage" alt="Card image cap"
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <button v-if="!laptopData.isAdded" type="button" class="btn btn-sm btn-outline-secondary"
                    v-on:click="addToCart(laptopData)">
                    Add to Cart
                  </button>
                  <button class="btn btn-sm btn-outline-secondary" disabled v-else>
                    Added
                  </button>
                </div>
              </div>
